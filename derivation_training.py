...
def T5Trainer(
    train_set, dev_set, source_text, target_text, model_params, output_dir="/home/e87596jm/Generation/outputs/"
):
    ...
    for epoch in loop:
        ...
        for epoch in range(model_params["VAL_EPOCHS"]):
            ...
            eval_score = np.mean(metric.compute()["rouge2"])
            ...
            console.log(f"[Validation Completed. Best ROUGE score: {best_eval_score}. Current ROUGE score: {eval_score}]\n")
...
d_json = [{'prompt':i['prompt'], 'derivation':i['derivation']} for i in d_json]

from datasets import Dataset, concatenate_datasets
dataset = Dataset.from_list(d_json).train_test_split(test_size=0.05)
...
model_params = {
    ...
    "TRAIN_EPOCHS": 10, #currently 20 last time this was accessed # number of training epochs
...
T5Trainer(
    ...
    output_dir="/home/e87596jm/Generation/outputs/",
)